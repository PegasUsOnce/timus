...
void print_day_of_week(const int day_of_week, const bool skipFirst, const int firstNum, const int maxNum, const int selectedNum) {
...
int main() {
    ...
    for (int i = 1; i < 8; i++) {
        ...
        print_day_of_week(i, skipFirst, startNum, daysInMonth, day);
    }
